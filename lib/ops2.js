(function() {
  ...
  µ.DOM.ready(async function() {
    var $, counter_increment, mouse_moved, spinner_toggle;
    log('^ops2@123-3^', "ready");
    IT.on('whatever', function(note) {
    ...
    //.........................................................................................................
    IT.on('spinner-toggle', spinner_toggle = function(note) {
      var event;
      event = note.$value;
    ...
    //.........................................................................................................
    IT.on('mous-moved', mouse_moved = function(note) {
      return log('^ops2@123-1^', {
        x: note.$value.clientX,
        y: note.$value.clientY
      });
    });
    IT.on('counter-increment', counter_increment = function(note) {
      return log('^ops2@123-1^', "counter-increment");
    });
    //.........................................................................................................
