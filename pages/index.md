...
<div id=spinner _="
  ...
  on toggle_spinner queue all
    log me
    // js alert( 'helo' ); end
    wait 0.5s then toggle .visible on me end
  on toggle_spinner from document queue all
    wait 0.5s then toggle .visible on me end
...
<div>
  ...
  <button class=show _='on click send toggle_spinner to #spinner'>Toggle spinner using event</button>
  <button class=show _='on click send toggle_spinner to document'>Toggle spinner using event to document</button>
