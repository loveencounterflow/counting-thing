...
<div>
  ...
  <button class=show _='on click send E(to:#spinner,key:"toggle") to #bus'>Toggle spinner</button>
  <button class=show _='on click send E(to:#spinner,key:"show") to #bus'>Show spinner</button>
  <button class=show _='on click send E(to:#spinner,key:"hide") to #bus'>Hide spinner</button>
  <button class=show _='on click send E(to:#spinner,key:"remove") to #bus'>Remove spinner</button>
